...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Download Feedback & Ephemeral Purge Trigger
  downloadMdBtn.addEventListener('click', () => {
    showToast(`Downloaded: ${uniqueFilenameBadge.textContent}`);
    if (currentSessionId) {
      // Trigger ephemeral post-download file purge on server
      fetch(`/api/purge/${currentSessionId}`, { method: 'POST' }).catch(() => {});
    }
  });
